  ...
  return (
    <div className="w-full max-w-md bg-card/80 backdrop-blur-md border border-border rounded-2xl p-8 shadow-soft">
      <div className="text-center mb-8">
        <h1 className="text-2xl font-heading font-bold uppercase tracking-wide mb-2">Welcome Back</h1>
        <p className="text-sm text-textSecondary">Sign in to access your AI racing insights.</p>
      </div>
